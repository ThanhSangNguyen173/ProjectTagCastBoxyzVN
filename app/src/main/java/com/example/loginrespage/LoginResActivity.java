...
public class LoginResActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (!str1.isEmpty() || !str2.isEmpty()) {
                    if(str1.equals(taikhoan) && str2.equals(matkhau)){
                        ...
                        overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_left);
                        Toast.makeText(LoginResActivity.this, "Welcome back, Sang Thuận Hưng ", Toast.LENGTH_SHORT).show();
                    }else {
                        Toast.makeText(LoginResActivity.this, "Vui lòng kiểm tra lại ID/Password!", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(LoginResActivity.this, "Vui lòng nhập đầy đủ thông tin!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog = new Dialog(LoginResActivity.this);
                ...
                dky2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (dk1.isEmpty() || dk2.isEmpty() || dk3.isEmpty() || dk4.isEmpty() || taikhoan.isEmpty() ||matkhau.isEmpty() || b ) {
                            Toast.makeText(LoginResActivity.this, "Vui lòng nhập đầy đủ thông tin và đồng ý điều khoản sử dụng!", Toast.LENGTH_SHORT).show();
                        }else {
                            tk.setText(taikhoan);
                            mk.setText(matkhau);
                            dialog.cancel();
                            Toast.makeText(LoginResActivity.this, "Đăng ký thành công!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void controlbutton() {
        btnthoat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(LoginResActivity.this, android.R.style.Theme_DeviceDefault_Light_Dialog);
